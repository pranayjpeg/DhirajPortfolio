    ...
    <section id="contact" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            I'm currently available for freelance projects, collaborations, or full-time
            positions. Feel free to reach out if you're interested in working together or
            ...
            <div className="flex gap-4">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center transition-transform hover:translate-y-[-2px]"
