  ...
  return (
    <section id="projects" className="py-24 px-6 relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_70%,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0.06)_50%)]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex p-1 bg-black/5 rounded-lg">
            {tabs.map((tab) => (
              <button
                key={tab}
